# Generated by Django 4.2.4 on 2023-09-25 20:23
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('product', '0010_alter_product_brand'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(default='m28c740ke69jib1', max_length=15)),
                ('status', models.CharField(choices=[('Order Recieved', 'Order Recieved'), ('Order Processed', 'Order Processed'), ('Order Shipped', 'Order Shipped'), ('Order Delivered', 'Order Delivered')], max_length=50)),
                ...
                ('delevery_time', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('products', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_detail_products', to='product.product')),
            ],
        ),
        migrations.CreateModel(
            name='CartDetail',
            fields=[
                ...
                ('products', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cart_detail_products', to='product.product')),
            ],
        ),
    ]
