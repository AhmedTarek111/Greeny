...
class Product(models.Model):
    ...
    brand = models.ForeignKey('Brand',verbose_name=_('Brand'),on_delete=models.SET_NULL)
    def __str__(self):
        return self.name
...
class Review(models.Model):
    user = models.ForeignKey(verbose_name=_("User"),on_delete=models.SET_NULL,null=True)
    proudct = models.ForeignKey(verbose_name=_("Proudct"),on_delete=models.CASCADE)
